import '../../App.css';
import DropdownCSS from './DropdownMenu.module.css';
        ...
        <div className={DropdownCSS.dropdownContainer}>
            ...
            >
                    <ul className={DropdownCSS.dropdownList}>
                        ...
                        <li>
                            <i className={`fa-brands fa-github ${DropdownCSS.githubIcon}`}></i>
                            <a href="https://github.com/TristanWongg" target="_blank" rel="noreferrer" className={DropdownCSS.menuText}>GitHub</a>
                        </li>
                        <li>
                            <i className={`fa-brands fa-linkedin ${DropdownCSS.linkedinIcon}`}></i>
